"""Regenerate the doc tables built from ``assumptions.yaml`` (run from the repository root)::
...
from rosettalog.frontends.qradar_lsx.assumptions import generated_docs
