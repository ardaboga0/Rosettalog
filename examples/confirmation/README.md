...
| [10](10-devicetime-two-digit-year) | A11 | How are two-digit years (yy) expanded? | 1: `evt=E1 d=01/02/26 10:00` → EventName=`E1`, DeviceTime=`2026-02-01T10:00:00.000Z`<br>2: `evt=E2 d=01/02/69 10:00` → EventName=`E2`, DeviceTime=`2069-02-01T10:00:00.000Z` | To 2000-2099 (69 becomes 2069). | A sliding pivot (69 becomes 1969). | unconfirmed |
