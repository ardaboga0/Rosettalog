...
| A11 | How does QRadar expand two-digit years (yy) in ext-data formats? | A fixed 2000-2099 window (69 becomes 2069, 50 becomes 2050). Kept unchanged until observed on QRadar. | per artifact: `DATE_TWO_DIGIT_YEAR_PIVOT` | [10](../examples/confirmation/10-devicetime-two-digit-year) | **unconfirmed, evidence against**: Joda-Time's default for 'yy' (used by QRadar ext-data formats) is a sliding window from the current year -80 to +19, i.e. 1946-2045 in 2026 (69 -> 1969, 50 -> 1950); source: Joda DateTimeFormat.java appendTwoDigitYear(<current year> - 30). |
